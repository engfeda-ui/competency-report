...
| Plugin (local folder) | Production Path | Output ZIP Name | Folder Inside ZIP |
|---|---|---|---|
| `competency-report` | `/home/ubuntu/moodle-project/local/comp_report_ext/` | `local_comp_report_ext.zip` | `comp_report_ext/` |
| `block_competency_report` | `/home/ubuntu/moodle-project/blocks/comp_report_ext/` | `block_comp_report_ext.zip` | `comp_report_ext/` |
| `competency` | `/home/ubuntu/moodle-project/question/bank/comp_ext/` | `qbank_comp_ext.zip` | `comp_ext/` |
| `failgrade` | `/home/ubuntu/moodle-project/mod/quiz/accessrule/failgrade_ext/` | `quizaccess_failgrade_ext.zip` | `failgrade_ext/` |
| `attemptpassword` | `/home/ubuntu/moodle-project/mod/quiz/accessrule/attemptpassword/` | `quizaccess_attemptpassword.zip` | `attemptpassword/` |
