...
class competency_calculator {
    ...
    /**
     * Evaluate a numerical percentage according to the academic 9-tier GPA scale.
     *
     * Scale:
     *   ≥ 95% -> Exceptional  (GPA: 5.0,  Letter: A+)
     *   ≥ 90% -> Excellent    (GPA: 4.75, Letter: A)
     *   ≥ 85% -> Superior     (GPA: 4.5,  Letter: B+)
     *   ≥ 80% -> Very Good    (GPA: 4.0,  Letter: B)
     *   ≥ 75% -> Above Avg    (GPA: 3.5,  Letter: C+)
     *   ≥ 70% -> Good         (GPA: 3.0,  Letter: C)
     *   ≥ 65% -> High Pass    (GPA: 2.5,  Letter: D+)
     *   ≥ 60% -> Pass         (GPA: 2.0,  Letter: D)
     *    < 60% -> Fail         (GPA: 1.0,  Letter: F)
     *
     * @param float $pct Percentage score (0 - 100).
     * @return array Array with keys: key, label, gpa, letter, color, badge.
     */
    public static function eval_scale(float $pct): array {
        if ($pct >= 95.0) {
            return [
                'key'    => 'exceptional',
                'label'  => get_string('eval_exceptional', 'local_comp_report_ext'),
                'gpa'    => 5.0,
                'letter' => 'A+',
                'color'  => '#28a745',
                'badge'  => 'badge-success',
            ...
            return [
                'key'    => 'excellent',
                'label'  => get_string('eval_excellent', 'local_comp_report_ext'),
                'gpa'    => 4.75,
                'letter' => 'A',
                'color'  => '#28a745',
                'badge'  => 'badge-success',
            ...
            return [
                'key'    => 'superior',
                'label'  => get_string('eval_superior', 'local_comp_report_ext'),
                'gpa'    => 4.5,
                'letter' => 'B+',
                'color'  => '#17a2b8',
                'badge'  => 'badge-info',
            ...
            return [
                'key'    => 'verygood',
                'label'  => get_string('eval_verygood', 'local_comp_report_ext'),
                'gpa'    => 4.0,
                'letter' => 'B',
                'color'  => '#17a2b8',
                'badge'  => 'badge-info',
            ...
            return [
                'key'    => 'aboveavg',
                'label'  => get_string('eval_aboveavg', 'local_comp_report_ext'),
                'gpa'    => 3.5,
                'letter' => 'C+',
                'color'  => '#ffc107',
                'badge'  => 'badge-warning',
            ...
            return [
                'key'    => 'good',
                'label'  => get_string('eval_good', 'local_comp_report_ext'),
                'gpa'    => 3.0,
                'letter' => 'C',
                'color'  => '#ffc107',
                'badge'  => 'badge-warning',
            ...
            return [
                'key'    => 'highpass',
                'label'  => get_string('eval_highpass', 'local_comp_report_ext'),
                'gpa'    => 2.5,
                'letter' => 'D+',
                'color'  => '#007bff',
                'badge'  => 'badge-primary',
            ...
            return [
                'key'    => 'pass',
                'label'  => get_string('eval_pass', 'local_comp_report_ext'),
                'gpa'    => 2.0,
                'letter' => 'D',
                'color'  => '#6c757d',
        ...
        return [
            'key'    => 'fail',
            'label'  => get_string('eval_fail', 'local_comp_report_ext'),
            'gpa'    => 1.0,
            'letter' => 'F',
            'color'  => '#dc3545',
            'badge'  => 'badge-danger',
