...
$string['typeoral'] = 'تقييم شفهي';
$string['typeassign'] = 'واجب / مهمة تدريبية';
$string['selectactivity'] = 'اختر الاختبار أو النشاط...';
$string['quizzes_group'] = 'الاختبارات (شفهي / عملي / تحريري)';
$string['assignments_group'] = 'الواجبات والمهام';
